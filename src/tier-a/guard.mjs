...
import { CONTEXT_PHASE } from './events.mjs';

const EXIT_ALLOW = 0;
const EXIT_BLOCK = 2;

// Event → context phase. See events.mjs for why it is a separate module
// and why UserPromptSubmit stays mapped although nothing wires it.
